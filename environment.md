...
See the shared [agent interface](https://vox-deorum.github.io/game-sandbox/students/agent-interface/) for `reset`, optional learning, chat, and submission details.
